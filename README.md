...
**[To_do_list]** This project is an basic calculator web app  that allows users to perform simple calculations.
...
```sh
  git https://github.com/adeola003/to_do_list_react.git
  cd to_do_list_react
```
